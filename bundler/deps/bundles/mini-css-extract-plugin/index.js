...
const { validate } = require("@effect-x/deps/compiled/schema-utils3")
const { getUndoPath } = require("@effect-x/deps/compiled/webpack/utilIdentifier")
const {
  trueFn,
  MODULE_TYPE,
  AUTO_PUBLIC_PATH,
...
class MiniCssExtractPlugin {
  static getCssModule(webpack) {
    ...
    class CssModule extends webpack.Module {
      constructor({ context, identifier, identifierIndex, content, media, sourceMap, assets, assetsInfo }) {
    ...
    compiler.hooks.thisCompilation.tap(pluginName, (compilation) => {
      ...
      class CssLoadingRuntimeModule extends RuntimeModule {
        ...
        generate() {
          ...
          const withLoading =
            runtimeRequirements.has(RuntimeGlobals.ensureChunkHandlers) && Object.keys(chunkMap).length > 0
          ...
          return Template.asString([
            `var createStylesheet = ${runtimeTemplate.basicFunction("chunkId, fullhref, resolve, reject", [
            ...
            withLoading
              ? Template.asString([
                  ...
                  "};",
                  "",
                  `${RuntimeGlobals.ensureChunkHandlers}.miniCss = ${runtimeTemplate.basicFunction(
                    "chunkId, promises",
                    [
            ...
            withHmr
              ? Template.asString([
                  ...
                  `${RuntimeGlobals.hmrDownloadUpdateHandlers}.miniCss = ${runtimeTemplate.basicFunction(
  ...
  renderContentAsset(compiler, compilation, chunk, modules, requestShortener, filenameTemplate, pathData) {
    ...
    for (const module of usedModules) {
      ...
      if (startsWithAtRuleImport) {
        ...
        content = content.replace(new RegExp(DOUBLE_DOT_PATH_SEGMENT, "g"), "..")
